...
c.htmlspecialchars(b)+"</div>";$(a.targ).before('<div id="'+c.eid+'" class="tce_content_c">'+d+'<div class="tce_content_x sc_editor_container"><div'+e+' class="tce_content">'+b+'</div><div class="clear"></div>'+f+"</div></div>").hide();b=document.createElement("p");d=$("#"+c.eid+" .tce_content").get(0);(e=d.firstChild)&&"#text"==e.nodeName&&(b.appendChild(e),d.prepend(b));document.getElementById(c.eid).addEventListener("paste",function(a){if($(a.target).parents(".tce_content").length){a.preventDefault();
var b="";textarr=a.clipboardData.getData("text/plain").trim().split("\n");if(textarr.length)for(a=0;a<textarr.length;a++)textarr[a].trim()&&(b+="<p>"+textarr[a].trim()+"</p>");b&&document.execCommand("insertHTML",!1,b)}else if($(a.target).hasClass("sc_code_editor_c")||$(a.target).parents(".sc_code_editor_c").length)b=$(a.target).parents(".tce_content_c").attr("id"),c.pasteCodeFormat({e:a,id:b})});$("#sc_code_editor_"+c.eid).on("keydown",function(a){$(a.target).parents(".tce_content_c").attr("id");
if($(a.target).hasClass("sc_code_editor_c")){if(13==a.keyCode)return a.preventDefault(),document.execCommand("insertHTML",!1,"\n"),a.stopPropagation(),!1;if(9==a.keyCode)return document.execCommand("insertHTML",!1,"\t"),!1}});$("#"+c.eid).on("keyup",function(a){var b=$(a.target).parents(".tce_content_c").attr("id");c.keyUp({e:a,id:b})});$("#"+c.eid+" .tce_content").on("click","img,p,h1,h2,h3,h4,li,ul,ol,td,th,table,blockquote,a,b,strong,i,em,u,s,strike,span,div",function(b){b.stopPropagation();1!=
a.disable&&c.editElm({e:b,t:this})});$("#"+c.eid).on("mousedown",".tce_tools_btn",function(a){a=$(this).parents(".tce_content_c").attr("id");c.saveRange({id:a})});$("#"+c.eid).on("click",".tce_tools_btn",function(b){var d=$(this).parents(".tce_content_c").attr("id");if(d&&1!=a.disable){c.restoreRange({id:d});b.stopPropagation();$(this).parent().find(".tce_tools_btn_active").removeClass("tce_tools_btn_active");b=$(this).attr("data-action");var e=$(this).attr("data-val");b&&c.tools[b].apply&&c.tools[b].apply({val:e,
id:d,t:$(this)});$(this).addClass("tce_tools_btn_active")}});return c.eid}};this.tools={format:{button:function(a){return c.getOption({name:"format",id:a.id,options:[{name:"\u0417\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a 1",val:"h1",css:"h1"},{name:"\u0417\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a 2",val:"h2",css:"h2"},{name:"\u0417\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a 3",val:"h3",css:"h3"},{name:"\u0417\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a 4",val:"h4",css:"h4"},
{name:"\u041f\u0430\u0440\u0430\u0433\u0440\u0430\u0444",val:"p",selected:!0,css:"p"},{name:"\u0426\u0438\u0442\u0430\u0442\u0430",val:"blockquote",css:"blockquote"}]})},apply:function(a){var b=a.id;!b||"undefined"==typeof c.param[b]||"h1"!=c.param[b].conttagname&&"h2"!=c.param[b].conttagname&&"h3"!=c.param[b].conttagname&&"h4"!=c.param[b].conttagname&&"p"!=c.param[b].conttagname&&"blockquote"!=c.param[b].conttagname||($(c.param[b].cont).replaceWith(function(b,c){return $("<"+a.val+' id="tce-replacer">').html(c)}),
c.detectEl({id:"#"+b+" #tce-replacer"}),$("#"+b+" #tce-replacer").removeAttr("id"))},sel:function(a){var b=a.id;a&&b&&a.tn&&$("#"+b+" .tce_tools_select_format .tce_tools_select_option."+a.tn).length&&($("#"+b+" .tce_tools_select_format .tce_tools_selected").removeClass("tce_tools_selected"),$("#"+b+" .tce_tools_select_format .tce_tools_select_option."+a.tn).addClass("tce_tools_selected"))}},align:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_align_c"><span data-action="align" data-val="left" title="\u041f\u043e \u043b\u0435\u0432\u043e\u043c\u0443 \u043a\u0440\u0430\u044e" class="tce_tools_btn tce_align-left"></span><span data-action="align" data-val="center" title="\u041f\u043e \u0446\u0435\u043d\u0442\u0440\u0443" class="tce_tools_btn tce_align-center"></span><span data-action="align" data-val="right" title="\u041f\u043e \u043f\u0440\u0430\u0432\u043e\u043c\u0443 \u043a\u0440\u0430\u044e" class="tce_tools_btn tce_align-right"></span><span data-action="align" data-val="justify" title="\u041f\u043e \u0448\u0438\u0440\u0438\u043d\u0435" class="tce_tools_btn tce_align-justify"></span></span>'},
...
img:{sel:function(a){$("#"+a.id+" .sc_visual_active").removeClass("sc_visual_active");$(c.param[a.id].el).addClass("sc_visual_active");c.addMinipan({id:a.id},[{tool:"img",action:"nofloat",css:"tce_img-nofloat",title:"\u0411\u0435\u0437 \u043e\u0431\u0442\u0435\u043a\u0430\u043d\u0438\u044f"},{tool:"img",action:"floatleft",css:"tce_img-floatleft",title:"\u041e\u0431\u0442\u0435\u043a\u0430\u043d\u0438\u0435 \u043f\u043e \u043b\u0435\u0432\u043e\u043c\u0443 \u043a\u0440\u0430\u044e"},{tool:"img",action:"floatright",
css:"tce_img-floatright",title:"\u041e\u0431\u0442\u0435\u043a\u0430\u043d\u0438\u0435 \u043f\u043e \u043f\u0440\u0430\u0432\u043e\u043c\u0443 \u043a\u0440\u0430\u044e"}])},nofloat:function(a){$(c.param[a.id].el).removeClass("lfs-fl-left lfs-fl-right").click()},floatleft:function(a){$(c.param[a.id].el).removeClass("lfs-fl-left lfs-fl-right").addClass("lfs-fl-left").click()},floatright:function(a){$(c.param[a.id].el).removeClass("lfs-fl-left lfs-fl-right").addClass("lfs-fl-right").click()},param:function(a){}},
...
a.id+"',x:"+c+",y:"+f+'});" onmouseover="tsxEd.tools.table.seltd({t:this,id:\''+a.id+"',x:"+c+",y:"+f+'});" title="'+f+"x"+c+'">&nbsp;</td>';b+="<tr>"+e+"</tr>"}return b+"</table></div>"},addrow:function(a){if($(c.param[a.id].el).length&&(a=$(c.param[a.id].el).parents("tr:first"),a.length)){a.find("td");var b="";a.find("td").each(function(){var a=$(this).attr("colspan");b+="<td"+(a?' colspan="'+a+'"':"")+"></td>"});a.after("<tr>"+b+"</tr>")}},addcol:function(a){if($(c.param[a.id].el).length){var b=
$(c.param[a.id].el).index();$(c.param[a.id].cont).find("tr").each(function(){$(this).find("td:eq("+b+")").after("<td></td>")})}},delrow:function(a){$(c.param[a.id].el).length&&$(c.param[a.id].el).parents("tr:first").remove()},delcol:function(a){if($(c.param[a.id].el).length){var b=$(c.param[a.id].el).index();$(c.param[a.id].cont).find("tr").each(function(){$(this).find("td:eq("+b+")").remove()})}},joincol:function(a){if($(c.param[a.id].el).length){var b=$(c.param[a.id].el).next();if(b.length){var d=
$(c.param[a.id].el).attr("colspan"),e=b.attr("colspan");d=d?parseInt(d):1;e=e?parseInt(e):1;d+=e;$(c.param[a.id].el).attr({colspan:d});b.remove()}}},splitcol:function(a){if($(c.param[a.id].el).length){var b=parseInt($(c.param[a.id].el).attr("colspan"));if(0<b){for(var d="",e=1;e<b;e++)d+="<td></td>";$(c.param[a.id].el).removeAttr("colspan").after(d)}}},sel:function(a){c.addMinipan({id:a.id},[{tool:"table",action:"addrow",css:"tce_table-addrow",title:"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0441\u0442\u0440\u043e\u043a\u0443"},
...
apply:function(a){if("addCode"==a.action){var b=$("#"+a.id+" .tce_tools_pop_c textarea[name=code]").val();0<b.length&&(b='<div class="nui_iframe">'+b+"</div>","undefined"!=typeof c.param[a.id]&&"undefined"!=typeof c.param[a.id].cont?$(c.param[a.id].cont).after(b):$("#"+a.id+" .tce_content").append(b));c.closePop(a)}else if("saveCode"==a.action){b=$("#"+a.id+" .tce_tools_pop_c textarea[name=code]").val();var d=$("#"+a.id+" .sc_frame_form_xcheckbox[name=del]").hasClass("checked");b&&$(c.param[a.id].el).text(b);
d&&($(c.param[a.id].el).remove(),c.param[a.id]=void 0);c.closePop(a)}else c.addPop({id:a.id,title:"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043e\u0431\u044a\u0435\u043a\u0442 \u0438\u043b\u0438 \u043a\u043e\u0434",content:'<div class="tce_tools_pop_form_c"><div class="tce_tools_pop_form_i"><textarea placeholder="\u0412\u0441\u0442\u0430\u0432\u044c\u0442\u0435 \u043a\u043e\u0434" name="code"></textarea></div></div>',button:[{title:"OK",tools:"object",action:"addCode",active:1},{title:"\u041e\u0442\u043c\u0435\u043d\u0430",
action:"close"}]})},sel:function(a){var b=$(c.param[a.id].el).text();c.addPop({id:a.id,title:"\u0421\u0432\u043e\u0439\u0441\u0442\u0432\u0430 \u043e\u0431\u044a\u0435\u043a\u0442\u0430 \u0438\u043b\u0438 \u043a\u043e\u0434",content:'<div class="tce_tools_pop_form_c"><div class="tce_tools_pop_form_i"><textarea placeholder="\u0412\u0441\u0442\u0430\u0432\u044c\u0442\u0435 \u043a\u043e\u0434" name="code">'+b+'</textarea></div><div class="tce_tools_pop_form_i"><label></label><span onclick="$(this).children().toggleClass(\'checked\');" class="sc_frame_form_xlable"><span name="del" data-value="1" class="sc_frame_form_checkbox sc_frame_form_xcheckbox"></span> \u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0441\u043e \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b</span></div></div>',
button:[{title:"OK",tools:"object",action:"saveCode",active:1},{title:"\u041e\u0442\u043c\u0435\u043d\u0430",action:"close"}]})}},html:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_html_c"><span data-action="html" data-val="show" title="\u0418\u0441\u0445\u043e\u0434\u043d\u044b\u0439 \u043a\u043e\u0434" class="tce_tools_btn tce_html-i"></span></span>'},apply:function(a){c.changeType({id:a.id})},sel:function(a){}},movie:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_movie_c"><span data-action="movie" title="\u041e\u043f\u0443\u0441\u0442\u0438\u0442\u044c \u0432\u043d\u0438\u0437" class="tce_tools_btn tce_movie-down"></span><span data-action="movie" title="\u041f\u043e\u0434\u043d\u044f\u0442\u044c \u0432\u0432\u0435\u0440\u0445" data-val="up" class="tce_tools_btn tce_movie-up"></span></span>'},
apply:function(a){c.closePop({id:a.id});if($(c.param[a.id].cont).length){if("table"==c.param[a.id].conttagname){var b=$(c.param[a.id].cont).parents(".sc_visual_table:first");b=b.length?b:$(c.param[a.id].cont)}else b=$(c.param[a.id].cont);a=a.val?a.val:"down";"up"==a?(a=b.prev(),a.length&&b.insertBefore(a)):"down"==a&&(a=b.next(),a.length&&b.insertAfter(a))}},sel:function(a){}},del:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_del_c"><span data-action="del" title="\u0423\u0434\u0430\u043b\u0438\u0442\u044c" class="tce_tools_btn tce_del"></span></span>'},
apply:function(a){var b=c.param[a.id].el,d=c.param[a.id].tagname;"p"==d||"h1"==d||"h2"==d||"h3"==d||"h4"==d||"blockquote"==d||"hr"==d||"obj"==d||"stick"==d?$(b).remove():"li"==d?$(b).parent().remove():"td"==d||"th"==d?(b.parents(".sc_visual_table:first").remove(),b.parents("table:first").remove()):"b"==d||"strong"==d||"i"==d||"em"==d||"u"==d||"span"==d&&("line-through"==$(b).css("text-decoration")||"underline"==$(b).css("text-decoration"))?$(b).contents().unwrap():"img"==d&&(d=b.parents(".nui_images_container:first"),
$(b).remove(),0==d.find("img").length&&d.remove());c.closePop({id:a.id});c.param[a.id]=void 0},sel:function(a){}},blank:{button:function(a){},apply:function(a){},sel:function(a){}}};this.changeType=function(a){if(a.id){var b=a.id;$("#sc_code_editor_"+b).length&&"block"==$("#sc_code_editor_"+b).css("display")?((a=$("#sc_code_editor_"+b).text())&&(a=c.clearCode(a)),$("#"+b+" .tce_content").html(a).show(),$("#sc_code_editor_"+b).hide(),$("#"+b+" .tce_tools_c").removeClass("sc_html_mode")):(c.closePop({id:a.id}),
a=$("#"+b+" .tce_content").html(),a=c.formatCode(c.clearCode(a)),$("#sc_code_editor_"+b).text(a).show().focus(),$("#"+b+" .tce_content").hide(),$("#"+b+" .tce_tools_c").addClass("sc_html_mode"))}};this.clearCode=function(a){a&&(a=a.replace(/<p><br><\/p>/gi,"").replace(/<p>\n<br><\/p>/gi,"").replace(/<p><\/p>/gi,""));return a};this.formatCode=function(a){a&&(a=a.replace(/<(p|h1|h2|h3|h4|br|ul|ol|table|tbody|blockquote|div|tr|td|li)(.*?)>/gi,"\n<$1$2>").replace(/<(tr|td|li)(.*?)>/gi,"\n\t<$1$2>").replace(/<\/(table|tbody|tr|div|ul|ol)>/gi,
...
!1,null);return!1};this.saveArea=function(a){if(a&&a.id){c.closePop({id:a.id});var b=!1;if($("#sc_code_editor_"+a.id).length&&"block"==$("#sc_code_editor_"+a.id).css("display")){b=!0;var d=$("#sc_code_editor_"+a.id)}else d=$("#"+a.id+" .tce_content");if(d.length&&(b=b?d.text():d.html(),$(c.textarea[a.id]).val(b),"function"==typeof a.callback&&a.callback({id:a.id,ta:c.textarea[a.id]}),a["return"]))return b}};this.addMinipan=function(a,b){$("#"+a.id+" .tce_content sub").remove();var d=$(c.param[a.id].el).position(),
e="";for(f in b)c.tools[b[f].tool][b[f].action]&&(e+="<span"+(b[f].title?' title="'+b[f].title+'"':"")+" onClick=\"tsxEd.tools['"+b[f].tool+"']['"+b[f].action+"']({id:'"+a.id+'\',t:$(this)});" class="tce_tools_btn '+b[f].css+'"></span>');var f=d.top-30;f=1>f?1:f;$("#"+a.id+" .tce_content").append('<sub alt="'+a.id+'" contenteditable="false" style="top:'+f+"px; left:"+(d.left+5)+'px" id="sc_visual_minipan_'+a.id+'" class="sc_visual_minipan">'+e+"</sub>");$("#sc_visual_minipan_"+a.id).fadeIn(300)};
this.addDpTool=function(a){if(a&&a.id&&a.tool){$("#"+a.id+" .tce_dp_tools_c").remove();var b=c.tools[a.tool].dptool?c.tools[a.tool].dptool({val:a.val,id:a.id}):"",d="";a.width&&(d+="width:"+a.width+";");a.height&&(d+="height:"+a.height+";");a.pos&&a.pos.left&&(d+="left:"+a.pos.left+"px;");$("#"+a.id).append("<div onClick=\"tsxEd.closePop({t:this,id:'"+a.id+'\'})" class="tce_tools_popbg_c"></div><div style="'+d+'" class="tce_dp_tools_c">'+b+"</div>")}};this.addPop=function(a){if(a&&a.id){$("#"+a.id+
" .tce_tools_pop_c, #"+a.id+" .tce_tools_popbg_c").remove();var b="";a.width&&(b+="width:"+a.width+";");a.height&&(b+="height:"+a.height+";");var c=a&&a.title?'<div class="tce_tools_pop_t">'+a.title+"</div>":"",e=a&&a.content?'<div class="tce_tools_pop">'+a.content+"</div>":"",f="";if(a&&a.button){f+='<div class="tce_tools_pop_btn_c">';for(var g in a.button)if(a.button[g].title){var k=a.button[g].active?" active":"",h="";"close"==a.button[g].action?h="tsxEd.closePop({t:this,id:'"+a.id+"'});":a.button[g].action&&
a.button[g].tools&&(h="tsxEd.tools['"+a.button[g].tools+"'].apply({id:'"+a.id+"',action:'"+a.button[g].action+"'});");f+='<span onClick="'+h+'" class="tce_tools_pop_btn'+k+'">'+a.button[g].title+"</span>"}f+="</div>"}$("#"+a.id).append('<div class="tce_tools_popbg_c"></div><div style="'+b+'" class="tce_tools_pop_c"><span onClick="tsxEd.closePop({t:this,id:\''+a.id+'\'});" class="tce_tools_pop_close"></span>'+c+'<div class="tce_tools_pop">'+e+"</div>"+f+"</div>")}};this.closePop=function(a){$("#"+
a.id+" .tce_tools_popbg_c, #"+a.id+" .tce_tools_pop_c, #"+a.id+" .tce_dp_tools_c, #"+a.id+" .sc_visual_minipan").remove();$("#"+a.id+" .tce_tools_select_activate").removeClass("tce_tools_select_activate")};this.numberPlus=function(a){if(a&&a.t){c.restoreRange({id:a.id});var b=$(a.t).parent().find(".tce_tools_numric_tx"),d=b.attr("data-min")?parseInt(b.attr("data-min")):0,e=b.attr("data-max")?parseInt(b.attr("data-max")):0,f=b.text();f=f?parseInt(f):d;d=a.s?f-1>=d?f-1:f:f+1<=e?f+1:f;f!=d&&a.action&&
c.tools[a.action].apply&&c.tools[a.action].apply({val:d,id:a.id})&&b.text(d)}};this.editElm=function(a){if(a=c.detectEl({t:a.t})){$("#"+a+" .sc_visual_active").removeClass("sc_visual_active");$("#"+a+" .tce_content sub").remove();$("#"+a+" .tce_tools_btn.tce_tools_btn_active").removeClass("tce_tools_btn_active");if("h1"==c.param[a].conttagname||"h2"==c.param[a].conttagname||"h3"==c.param[a].conttagname||"h4"==c.param[a].conttagname||"p"==c.param[a].conttagname||"blockquote"==c.param[a].conttagname)c.tools.format.sel({tn:c.param[a].conttagname,
id:a}),c.tools.font.sel({tn:c.param[a].conttagname,id:a}),c.tools.fontsize.sel({tn:c.param[a].conttagname,etn:c.param[a].tagname,id:a}),c.tools.align.sel({tn:c.param[a].conttagname,id:a}),$(c.param[a].el).hasClass("nui_images_container")&&$(c.param[a].el).addClass("sc_visual_active");"b"==c.param[a].tagname||"strong"==c.param[a].tagname||"i"==c.param[a].tagname||"em"==c.param[a].tagname||"u"==c.param[a].tagname||"s"==c.param[a].tagname||"strike"==c.param[a].tagname||"span"==c.param[a].tagname?c.tools.mark.sel({tn:c.param[a].tagname,
id:a}):"a"==c.param[a].tagname?c.tools.paint.sel({tn:c.param[a].tagname,id:a}):"img"==c.param[a].tagname?c.tools.img.sel({tn:c.param[a].tagname,id:a}):"td"==c.param[a].tagname||"th"==c.param[a].tagname?($(c.param[a].el).addClass("sc_visual_active"),c.tools.table.sel({tn:c.param[a].tagname,id:a})):"div"==c.param[a].tagname&&$(c.param[a].el).hasClass("nui_iframe")&&($(c.param[a].el).addClass("sc_visual_active"),c.tools.object.sel({tn:c.param[a].tagname,id:a}))}};this.detectEl=function(a){var b=!1;a&&
a.t?b=$(a.t):a&&a.id&&(b=$(a.id));if(0!=b&&(a=b.parents(".tce_content_c").attr("id"))){var d=b.get(0).tagName.toLowerCase(),e=b,f=d;if("td"==d||"th"==d){var g=b.parents("table:first");g.length&&(e=g,f="table")}else if("p"!=d||"ul"!=d||"ol"!=d)g=b.parents("p:first"),g.length&&(e=g,f=g.get(0).tagName.toLowerCase());c.param[a]={};c.param[a].tagname=d;c.param[a].conttagname=f;c.param[a].cont=e;c.param[a].el=b;return a}};this.showOption=function(a){a&&a.t&&($(a.t).addClass("tce_tools_select_activate"),
$("#"+a.id).append("<div onClick=\"tsxEd.closePop({t:this,id:'"+a.id+'\'})" class="tce_tools_popbg_c"></div>'))};this.getOption=function(a){var b="";if(a&&a.options&&a.name){b+="<span onClick=\"tsxEd.showOption({t:this,id:'"+a.id+'\'});" class="tce_tools_select_c tce_tools_select_'+a.name+'"><span class="tce_tools_select">';for(var c in a.options)a.options[c].val&&(b+='<span onClick="tsxEd.getOptionVal(this);" data-id="'+a.id+'" data-name="'+a.name+'" data-value="'+a.options[c].val+'" class="tce_tools_select_option'+
(a.options[c].selected?" tce_tools_selected":"")+(a.options[c].css?" "+a.options[c].css:"")+'">'+a.options[c].name+"</span>");b+="</span></span>"}return b};this.getOptionVal=function(a){if(a&&$(a).parents(".tce_tools_select_activate").length){var b=$(a).attr("data-value");b=b?b:"";var d=$(a).attr("data-name"),e=$(a).attr("data-id");d&&c.tools[d].apply&&(c.tools[d].apply({val:b,t:a,id:e}),$(a).parent().find(".tce_tools_selected").removeClass("tce_tools_selected"),$(a).addClass("tce_tools_selected"),
setTimeout(function(){$(a).parents(".tce_tools_select_activate").removeClass("tce_tools_select_activate");c.closePop({id:e})},.1))}};this.keyUp=function(a){a.e&&8==a.e.keyCode&&(a=a.id,$("#"+a+" .tce_content p, #"+a+" .tce_content div, #"+a+" .tce_content h1, #"+a+" .tce_content h2, #"+a+" .tce_content h3, #"+a+" .tce_content h4, #"+a+" .tce_content blockquote, #"+a+" .tce_content ul, #"+a+" .tce_content ol").length||(document.execCommand("insertHTML",!1,'<p id="tce-replacer"></p>'),c.detectEl({id:"#"+
a+" #tce-replacer"}),$("#"+a+" #tce-replacer").removeAttr("id")))};this.pasteFormat=function(a){a.id&&$("#"+a.id+" .tce_content").msword_html_filter()};this.pasteCodeFormat=function(a){a.id&&setTimeout(function(){$("#sc_code_editor_"+a.id).text($("#sc_code_editor_"+a.id).text())},.001)};this.stripTags=function(a,b){b=(((b||"")+"").toLowerCase().match(/<[a-z][a-z0-9]*>/g)||[]).join("");return a.replace(/\x3c!--[\s\S]*?--\x3e|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi,function(a,
c){return-1<b.indexOf("<"+c.toLowerCase()+">")?a:""})};this.uid=function(){return"_"+Math.random().toString(36).substr(2,9)};this.saveRange=function(a){if(a&&a.id){"undefined"==typeof c.param[a.id]&&(c.param[a.id]={});c.param[a.id].range=null;var b=window.getSelection();0<b.rangeCount&&(c.param[a.id].range=b.getRangeAt(0))}};this.restoreRange=function(a){a&&a.id&&"undefined"!=typeof c.param[a.id]&&(a=c.param[a.id].range)&&(window.getSelection?(s=window.getSelection(),0<s.rangeCount&&s.removeAllRanges(),
