...
apply:function(a){scHp.filesOpen(a.id,"file"==a.val?"txt,pdf,doc,docx,xls,xlsx":!1)},add:function(a){if(a.id&&1==a.file)"undefined"!=typeof c.param[a.id]?c.param[a.id].cont&&(c.restoreRange({id:a.id}),document.execCommand("insertHTML",!1,a.list)):$("#"+a.id+" .tce_content").append("<p>"+a.list+"</p>");else if(a.id&&a.imgs.length){for(var b="",d=0;d<a.imgs.length;d++)if(a.imgs[d])if(a.zoom){var e=a.imgs[d].split("/");e[e.length-1]=".thumb_"+e[e.length-1];imgi=e.join("/");b+='<img class="lifs_photo" src="'+
imgi+'"/>'}else b+=a.block?'<p class="nui_images_container"><img src="'+a.imgs[d]+'"/></p>':'<img src="'+a.imgs[d]+'"/>';a.zoom&&(b='<p class="nui_images_container">'+b+"</p>");"undefined"!=typeof c.param[a.id]?c.param[a.id].cont&&(a.zoom||a.block?$(c.param[a.id].cont).after(b):(c.restoreRange({id:a.id}),document.execCommand("insertHTML",!1,b))):$("#"+a.id+" .tce_content").append(b)}},sel:function(a){$("#"+a.id+" .tce_img-add").addClass("tce_tools_btn_active")}},list:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_list_c"><span data-action="list" title="\u0421\u043f\u0438\u0441\u043e\u043a" class="tce_tools_btn tce_list-ul"></span><span data-action="list" data-val="ol" title="\u041d\u0443\u043c\u0435\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0439 \u0441\u043f\u0438\u0441\u043e\u043a" class="tce_tools_btn tce_list-ol"></span></span>'},
apply:function(a){c.restoreRange({id:a.id});document.execCommand("ol"==a.val?"insertorderedlist":"insertUnorderedList")},sel:function(a){}},table:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_table_c"><span data-action="table" title="\u0422\u0430\u0431\u043b\u0438\u0446\u0430" class="tce_tools_btn tce_table-i"></span></span>'},apply:function(a){c.addDpTool({id:a.id,tool:"table",val:a.val,pos:a.t.position(),width:"114px",height:"87px"})},seltd:function(a){$("#"+a.id+" .tce_tools_btn_c.tce_btn_paint_c table td.active").removeClass("active");
for(var b=0;b<a.x;b++)for(var c=0;c<a.y;c++)$("#"+a.id+" .tce_tools_btn_c.tce_btn_paint_c table tr:eq("+b+") td:eq("+c+")").addClass("active")},add:function(a){c.closePop(a);for(var b='<div class="sc_visual_table"><table>',d=0;d<a.x;d++){for(var e="",f=0;f<a.y;f++)e+="<td></td>";b+="<tr>"+e+"</tr>"}b+="</table></div>";"undefined"!=typeof c.param[a.id]?c.param[a.id].cont&&$(c.param[a.id].cont).after(b):$("#"+a.id+" .tce_content").append(b)},dptool:function(a){for(var b='<div class="tce_tools_btn_c tce_btn_paint_c"><table>',
c=1;6>c;c++){for(var e="",f=1;8>f;f++)e+="<td onClick=\"tsxEd.tools.table.add({t:this,id:'"+a.id+"',x:"+c+",y:"+f+'});" onmouseover="tsxEd.tools.table.seltd({t:this,id:\''+a.id+"',x:"+c+",y:"+f+'});" title="'+f+"x"+c+'">&nbsp;</td>';b+="<tr>"+e+"</tr>"}return b+"</table></div>"},addrow:function(a){if($(c.param[a.id].el).length&&(a=$(c.param[a.id].el).parents("tr:first"),a.length)){for(var b=a.find("td").length,d="",e=0;e<b;e++)d+="<td></td>";a.after("<tr>"+d+"</tr>")}},addcol:function(a){if($(c.param[a.id].el).length){var b=
$(c.param[a.id].el).index();$(c.param[a.id].cont).find("tr").each(function(){$(this).find("td:eq("+b+")").after("<td></td>")})}},delrow:function(a){$(c.param[a.id].el).length&&$(c.param[a.id].el).parents("tr:first").remove()},delcol:function(a){if($(c.param[a.id].el).length){var b=$(c.param[a.id].el).index();$(c.param[a.id].cont).find("tr").each(function(){$(this).find("td:eq("+b+")").remove()})}},sel:function(a){c.addMinipan({id:a.id},[{tool:"table",action:"addrow",css:"tce_table-addrow"},{tool:"table",
action:"addcol",css:"tce_table-addcol"},{tool:"table",action:"delrow",css:"tce_table-delrow"},{tool:"table",action:"delcol",css:"tce_table-delcol"}])}},line:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_line_c"><span data-action="line" title="\u041b\u0438\u043d\u0438\u044f" class="tce_tools_btn tce_tools_line"></span></span>'},apply:function(a){c.restoreRange({id:a.id});document.execCommand("insertHorizontalRule")},sel:function(a){}},html:{button:function(a){return'<span class="tce_tools_btn_c tce_btn_html_c"><span data-action="html" data-val="show" title="\u0418\u0441\u0445\u043e\u0434\u043d\u044b\u0439 \u043a\u043e\u0434" class="tce_tools_btn tce_html-i"></span></span>'},
...
c.closePop({id:a.id});c.param[a.id]=void 0},sel:function(a){}},blank:{button:function(a){},apply:function(a){},sel:function(a){}}};this.changeType=function(a){if(a.id){var b=a.id;$("#sc_code_editor_"+b).length&&"block"==$("#sc_code_editor_"+b).css("display")?($("#"+b+" .tce_content").html($("#sc_code_editor_"+b).text()).show(),$("#sc_code_editor_"+b).hide(),$("#"+b+" .tce_tools_c").removeClass("sc_html_mode")):(c.closePop({id:a.id}),a=$("#"+b+" .tce_content").html(),a=c.formatCode(a),$("#sc_code_editor_"+
b).text(a).show().focus(),$("#"+b+" .tce_content").hide(),$("#"+b+" .tce_tools_c").addClass("sc_html_mode"))}};this.formatCode=function(a){a&&(a=a.replace(/<(p|h1|h2|h3|h4|br|ul|ol|table|tbody|blockquote|div|tr|td|li)(.*?)>/gi,"\n<$1$2>").replace(/<(tr|td|li)(.*?)>/gi,"\n\t<$1$2>").replace(/<\/(table|tbody|tr|div|ul|ol)>/gi,"</$1>\n"),a=a.replace(/(\n){1,}/g,"\n").replace(/(\n\t){1,}/g,"\n\t").trim());return a};this.codeColor=function(a){return a=a.replace(/&lt;(h1|h2|h3|h4|h5|a|textarea|b|strong|i|em|div|span|p|img|ul|ol|li|b|i|blockquote|br)((?:\s{1}[a-zA-Z]+="[^"]*"{1}\s*)*)&gt;{1}/gi,
'<i class="sc_tag">&lt;$1<i class="sc_tag_attr">$2</i>&gt;</i>').replace(/&lt;\/(h1|h2|h3|h4|h5|a|textarea|b|strong|i|em|div|span|p|img|ul|ol|li|b|i|blockquote)&gt;{1}/gi,'<i class="sc_tag">&lt;/$1&gt;</i>')};this.formatTag=function(a){window.document.execCommand(a,!1,null);return!1};this.saveArea=function(a){if(a&&a.id){c.closePop({id:a.id});var b=!1;if($("#sc_code_editor_"+a.id).length&&"block"==$("#sc_code_editor_"+a.id).css("display")){b=!0;var d=$("#sc_code_editor_"+a.id)}else d=$("#"+a.id+" .tce_content");
if(d.length&&(b=b?d.text():d.html(),$(c.textarea[a.id]).val(b),"function"==typeof a.callback&&a.callback({id:a.id,ta:c.textarea[a.id]}),a["return"]))return b}};this.addMinipan=function(a,b){$("#"+a.id+" .tce_content sub").remove();var d=$(c.param[a.id].el).position(),e="";for(f in b)c.tools[b[f].tool][b[f].action]&&(e+="<span onClick=\"tsxEd.tools['"+b[f].tool+"']['"+b[f].action+"']({id:'"+a.id+'\',t:$(this)});" class="tce_tools_btn '+b[f].css+'"></span>');var f=d.top-25;f=1>f?1:f;$("#"+a.id+" .tce_content").append('<sub alt="'+
a.id+'" contenteditable="false" style="top:'+f+"px; left:"+(d.left+5)+'px" id="sc_visual_minipan_'+a.id+'" class="sc_visual_minipan">'+e+"</sub>");$("#sc_visual_minipan_"+a.id).fadeIn(300)};this.addDpTool=function(a){if(a&&a.id&&a.tool){$("#"+a.id+" .tce_dp_tools_c").remove();var b=c.tools[a.tool].dptool?c.tools[a.tool].dptool({val:a.val,id:a.id}):"",d="";a.width&&(d+="width:"+a.width+";");a.height&&(d+="height:"+a.height+";");a.pos&&a.pos.left&&(d+="left:"+a.pos.left+"px;");$("#"+a.id).append("<div onClick=\"tsxEd.closePop({t:this,id:'"+
a.id+'\'})" class="tce_tools_popbg_c"></div><div style="'+d+'" class="tce_dp_tools_c">'+b+"</div>")}};this.addPop=function(a){if(a&&a.id){$("#"+a.id+" .tce_tools_pop_c, #"+a.id+" .tce_tools_popbg_c").remove();var b="";a.width&&(b+="width:"+a.width+";");a.height&&(b+="height:"+a.height+";");var c=a&&a.title?'<div class="tce_tools_pop_t">'+a.title+"</div>":"",e=a&&a.content?'<div class="tce_tools_pop">'+a.content+"</div>":"",f="";if(a&&a.button){f+='<div class="tce_tools_pop_btn_c">';for(var g in a.button)if(a.button[g].title){var k=
a.button[g].active?" active":"",h="";"close"==a.button[g].action?h="tsxEd.closePop({t:this,id:'"+a.id+"'});":a.button[g].action&&a.button[g].tools&&(h="tsxEd.tools['"+a.button[g].tools+"'].apply({id:'"+a.id+"',action:'"+a.button[g].action+"'});");f+='<span onClick="'+h+'" class="tce_tools_pop_btn'+k+'">'+a.button[g].title+"</span>"}f+="</div>"}$("#"+a.id).append('<div class="tce_tools_popbg_c"></div><div style="'+b+'" class="tce_tools_pop_c"><span onClick="tsxEd.closePop({t:this,id:\''+a.id+'\'});" class="tce_tools_pop_close"></span>'+
c+'<div class="tce_tools_pop">'+e+"</div>"+f+"</div>")}};this.closePop=function(a){$("#"+a.id+" .tce_tools_popbg_c, #"+a.id+" .tce_tools_pop_c, #"+a.id+" .tce_dp_tools_c, #"+a.id+" .sc_visual_minipan").remove();$("#"+a.id+" .tce_tools_select_activate").removeClass("tce_tools_select_activate")};this.numberPlus=function(a){if(a&&a.t){c.restoreRange({id:a.id});var b=$(a.t).parent().find(".tce_tools_numric_tx"),d=b.attr("data-min")?parseInt(b.attr("data-min")):0,e=b.attr("data-max")?parseInt(b.attr("data-max")):
0,f=b.text();f=f?parseInt(f):d;d=a.s?f-1>=d?f-1:f:f+1<=e?f+1:f;f!=d&&a.action&&c.tools[a.action].apply&&c.tools[a.action].apply({val:d,id:a.id})&&b.text(d)}};this.editElm=function(a){if(a=c.detectEl({t:a.t})){$("#"+a+" .tce_content sub").remove();$("#"+a+" .tce_tools_btn.tce_tools_btn_active").removeClass("tce_tools_btn_active");if("h1"==c.param[a].conttagname||"h2"==c.param[a].conttagname||"h3"==c.param[a].conttagname||"h4"==c.param[a].conttagname||"p"==c.param[a].conttagname||"blockquote"==c.param[a].conttagname)c.tools.format.sel({tn:c.param[a].conttagname,
id:a}),c.tools.font.sel({tn:c.param[a].conttagname,id:a}),c.tools.fontsize.sel({tn:c.param[a].conttagname,etn:c.param[a].tagname,id:a}),c.tools.align.sel({tn:c.param[a].conttagname,id:a});"b"==c.param[a].tagname||"strong"==c.param[a].tagname||"i"==c.param[a].tagname||"em"==c.param[a].tagname||"u"==c.param[a].tagname||"s"==c.param[a].tagname||"strike"==c.param[a].tagname||"span"==c.param[a].tagname?c.tools.mark.sel({tn:c.param[a].tagname,id:a}):"a"==c.param[a].tagname?c.tools.paint.sel({tn:c.param[a].tagname,
id:a}):"img"==c.param[a].tagname?c.tools.img.sel({tn:c.param[a].tagname,id:a}):("td"==c.param[a].tagname||"th"==c.param[a].tagname)&&c.tools.table.sel({tn:c.param[a].tagname,id:a})}};this.detectEl=function(a){var b=!1;a&&a.t?b=$(a.t):a&&a.id&&(b=$(a.id));if(0!=b&&(a=b.parents(".tce_content_c").attr("id"))){var d=b.get(0).tagName.toLowerCase(),e=b,f=d;if("td"==d||"th"==d){var g=b.parents("table:first");g.length&&(e=g,f="table")}else if("p"!=d||"ul"!=d||"ol"!=d)g=b.parents("p:first"),g.length&&(e=g,
f=g.get(0).tagName.toLowerCase());c.param[a]={};c.param[a].tagname=d;c.param[a].conttagname=f;c.param[a].cont=e;c.param[a].el=b;return a}};this.showOption=function(a){a&&a.t&&($(a.t).addClass("tce_tools_select_activate"),$("#"+a.id).append("<div onClick=\"tsxEd.closePop({t:this,id:'"+a.id+'\'})" class="tce_tools_popbg_c"></div>'))};this.getOption=function(a){var b="";if(a&&a.options&&a.name){b+="<span onClick=\"tsxEd.showOption({t:this,id:'"+a.id+'\'});" class="tce_tools_select_c tce_tools_select_'+
a.name+'"><span class="tce_tools_select">';for(var c in a.options)a.options[c].val&&(b+='<span onClick="tsxEd.getOptionVal(this);" data-id="'+a.id+'" data-name="'+a.name+'" data-value="'+a.options[c].val+'" class="tce_tools_select_option'+(a.options[c].selected?" tce_tools_selected":"")+(a.options[c].css?" "+a.options[c].css:"")+'">'+a.options[c].name+"</span>");b+="</span></span>"}return b};this.getOptionVal=function(a){if(a&&$(a).parents(".tce_tools_select_activate").length){var b=$(a).attr("data-value");
b=b?b:"";var d=$(a).attr("data-name"),e=$(a).attr("data-id");d&&c.tools[d].apply&&(c.tools[d].apply({val:b,t:a,id:e}),$(a).parent().find(".tce_tools_selected").removeClass("tce_tools_selected"),$(a).addClass("tce_tools_selected"),setTimeout(function(){$(a).parents(".tce_tools_select_activate").removeClass("tce_tools_select_activate");c.closePop({id:e})},.1))}};this.keyUp=function(a){a.e&&8==a.e.keyCode&&(a=a.id,$("#"+a+" .tce_content p, #"+a+" .tce_content div, #"+a+" .tce_content h1, #"+a+" .tce_content h2, #"+
...
.001)};this.stripTags=function(a,b){b=(((b||"")+"").toLowerCase().match(/<[a-z][a-z0-9]*>/g)||[]).join("");return a.replace(/\x3c!--[\s\S]*?--\x3e|<\?(?:php)?[\s\S]*?\?>/gi,"").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi,function(a,c){return-1<b.indexOf("<"+c.toLowerCase()+">")?a:""})};this.uid=function(){return"_"+Math.random().toString(36).substr(2,9)};this.saveRange=function(a){if(a&&a.id){"undefined"==typeof c.param[a.id]&&(c.param[a.id]={});c.param[a.id].range=null;var b=window.getSelection();0<
b.rangeCount&&(c.param[a.id].range=b.getRangeAt(0))}};this.restoreRange=function(a){a&&a.id&&"undefined"!=typeof c.param[a.id]&&(a=c.param[a.id].range)&&(window.getSelection?(s=window.getSelection(),0<s.rangeCount&&s.removeAllRanges(),s.addRange(a)):document.selection&&a.select())};this.htmlspecialchars=function(a){"string"==typeof a&&(a=a.replace(/&/g,"&amp;"),a=a.replace(/"/g,"&quot;"),a=a.replace(/'/g,"&#039;"),a=a.replace(/</g,"&lt;"),a=a.replace(/>/g,"&gt;"));return a}}var tsxEd=new tsxEdClass;